...
module SpannerExtensions =
    ...
    type Binder =
        ...
        static member Spanning(pattern:String) = PatternBindings.Spanner(pattern)
        static member Spanning(pattern:Char) = PatternBindings.Spanner(pattern)
        static member Spanning(pattern:Capture) = PatternBindings.Spanner(pattern)
