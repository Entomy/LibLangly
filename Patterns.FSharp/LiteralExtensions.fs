...
module LiteralExtensions =
    ...
    type Binder =
        ...
        static member Literal(value:sbyte) = value.AsPattern()
        static member Literal(value:byte) = value.AsPattern()
        static member Literal(value:uint16) = value.AsPattern()
        static member Literal(value:int16) = value.AsPattern()
        static member Literal(value:uint32) = value.AsPattern()
        static member Literal(value:int32) = value.AsPattern()
        static member Literal(value:uint64) = value.AsPattern()
        static member Literal(value:int64) = value.AsPattern()
