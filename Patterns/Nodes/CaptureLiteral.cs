...
namespace Stringier.Patterns.Nodes {
	...
	internal sealed class CaptureLiteral : Literal, IEquatable<CaptureLiteral> {
		...
		internal CaptureLiteral(Capture capture) : base(StringComparison.Ordinal) => Capture = capture;
		...
		internal CaptureLiteral(Capture capture, StringComparison comparisonType) : base(comparisonType) => Capture = capture;
		...
		public override Boolean Equals(ReadOnlySpan<Char> other) => Capture.Value.Equals(other, ComparisonType);
		...
		/// <returns><c>true</c> if representable; otherwise, <c>false</c>.</returns
		public override Boolean Equals(String other) => Capture.Value.Equals(other, ComparisonType);
		...
		/// <returns><c>true</c> if the specified <see cref="Node"/> is equal to the current <see cref="Node"/>; otherwise, <c>false</c>.</returns>
		public Boolean Equals(CaptureLiteral other) => Capture.Value.Equals(other.Capture.Value, ComparisonType);
