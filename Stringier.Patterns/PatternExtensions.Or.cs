...
namespace Stringier.Patterns {
	public static partial class PatternExtensions {
		...
		/// <returns>A new <see cref="Pattern"/> matching this <see cref="Pattern"/> or <paramref name="other"/>.</returns>
		[return: NotNull]
		public static Pattern Or([DisallowNull] this String rune, [AllowNull] Pattern other) => new MemoryLiteral(rune).Or(other);
		...
		/// <returns>A new <see cref="Pattern"/> matching this <see cref="Pattern"/> or <paramref name="other"/>.</returns>
		[return: NotNull]
		public static Pattern Or([DisallowNull] this String @string, [AllowNull] String other) => new MemoryLiteral(@string).Or(other);
	}
}
