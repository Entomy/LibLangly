namespace System.Text.Patterns {
	...
	/// </remarks>
	internal sealed class StringLiteral : Node, IPrimative, IEquatable<StringLiteral> {
		/// <summary>
		...
		public override Result Neglect(ref Source Source) => String.Neglect(ref Source, ComparisonType);
