namespace System.Text.Patterns {
	...
	public ref struct Result {
		...
		internal Result(Char Capture) : this(new ReadOnlySpan<Char>(new [] { Capture })) { }

		internal Result(Char Capture, Boolean Success) : this(new ReadOnlySpan<Char>(new [] { Capture }), Success) { }
