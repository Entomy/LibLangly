...
namespace Collectathon.Lists {
	public partial class StandardList<TElement, TNode, TSelf> {
		/// <summary>
		/// Provides enumeration over a <see cref="StandardList{TElement, TNode, TSelf}"/>.
		/// </summary>
		...
		public struct Enumerator : IEnumerator<TElement> {
			...
			/// </summary>
			[AllowNull, MaybeNull]
			private StandardList<TElement, TNode, TSelf> List;
			...
			public Enumerator([DisallowNull] StandardList<TElement, TNode, TSelf> list) {
				List = list;
				N = default;
			}
