...
namespace System.Text {
	...
	/// 
	/// </summary>
	public struct EnumerableRuneEnumerator : IEnumerable<Rune>, IEnumerator<Rune> {
		private readonly IEnumerator<Char> Chars;
		private Rune Rune;

		internal EnumerableRuneEnumerator(IEnumerable<Char> seq) {
		...
		/// <inheritdoc/>
		public EnumerableRuneEnumerator GetEnumerator() => this;
