...
namespace Collectathon.Sets {
	...
	internal sealed class Disjunction<TElement> : Combinator<TElement> where TElement : IEquatable<TElement> {
		/// <inheritdoc/>
		internal Disjunction(Set<TElement> first, Set<TElement> second) : base(first, second) { }
