...
namespace Collectathon {
	...
	/// </remarks>
	[Serializable]
	public abstract class DataStructure<TIndex, TElement, TSelf, TEnumerator> : ICloneable<TSelf>, IEnumerable<Association<TIndex, TElement>, TEnumerator>, IEquatable<DataStructure<TIndex, TElement, TSelf, TEnumerator>>, IEquatable<Association<TIndex, TElement>[]>, IEquatable<System.Collections.Generic.IEnumerable<Association<TIndex, TElement>>> where TIndex : IEquatable<TIndex> where TSelf : DataStructure<TIndex, TElement, TSelf, TEnumerator> where TEnumerator : IEnumerator<Association<TIndex, TElement>> {
		/// <summary>
		/// The filter used.
		/// </summary>
		/// <remarks>
		...
		{
			Filter.Unique => NullFilter<TElement>.Instance, // All indicies of an associative collection are already unique, so we don't need to use this filter.
		...
		public static Boolean operator !=(DataStructure<TIndex, TElement, TSelf, TEnumerator> left, DataStructure<TIndex, TElement, TSelf, TEnumerator> right) => !(left == right);

		public static Boolean operator !=(DataStructure<TIndex, TElement, TSelf, TEnumerator> left, TElement[] right) => !(left == right);

		public static Boolean operator !=(TElement[] left, DataStructure<TIndex, TElement, TSelf, TEnumerator> right) => !(left == right);

		public static Boolean operator !=(DataStructure<TIndex, TElement, TSelf, TEnumerator> left, System.Collections.Generic.IEnumerable<TElement> right) => !(left == right);

		public static Boolean operator !=(System.Collections.Generic.IEnumerable<TElement> left, DataStructure<TIndex, TElement, TSelf, TEnumerator> right) => !(left == right);

		public static Boolean operator ==(DataStructure<TIndex, TElement, TSelf, TEnumerator> left, DataStructure<TIndex, TElement, TSelf, TEnumerator> right) => (left is null && right is null) || (left?.Equals(right) ?? false);

		public static Boolean operator ==(DataStructure<TIndex, TElement, TSelf, TEnumerator> left, TElement[] right) => (left is null && right is null) || (left?.Equals(right) ?? false);

		public static Boolean operator ==(TElement[] left, DataStructure<TIndex, TElement, TSelf, TEnumerator> right) => (left is null && right is null) || (right?.Equals(left) ?? false);

		public static Boolean operator ==(DataStructure<TIndex, TElement, TSelf, TEnumerator> left, System.Collections.Generic.IEnumerable<TElement> right) => (left is null && right is null) || (left?.Equals(right) ?? false);

		public static Boolean operator ==(System.Collections.Generic.IEnumerable<TElement> left, DataStructure<TIndex, TElement, TSelf, TEnumerator> right) => (left is null && right is null) || (right?.Equals(left) ?? false);
		...
		public sealed override Boolean Equals(Object obj) {
			switch (obj) {
			case DataStructure<TIndex, TElement, TSelf, TEnumerator> dataStructure:
				return Equals(dataStructure);
			case (TIndex, TElement)[] array:
				return Equals(array);
			case System.Collections.Generic.IEnumerable<(TIndex, TElement)> enumerable:
