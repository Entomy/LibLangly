...
namespace Numbersome {
	public static partial class ArithmeticExtensions {
		...
		public static void Add([DisallowNull] this IStack<nint> stack) {
		...
		/// <param name="stack">This stack.</param>
		[CLSCompliant(false)]
		public static void Add([DisallowNull] this IStack<nuint> stack) {
		...
		/// </summary>
		/// <param name="stack">This stack.</param>
		public static void Add([DisallowNull] this IStack<Int32> stack) {
		...
		/// <param name="stack">This stack.</param>
		[CLSCompliant(false)]
		public static void Add([DisallowNull] this IStack<UInt32> stack) {
		...
		/// </summary>
		/// <param name="stack">This stack.</param>
		public static void Add([DisallowNull] this IStack<Int64> stack) {
		...
		/// </summary>
		/// <param name="stack">This stack.</param>
		public static void Add([DisallowNull] this IStack<Double> stack) {
		...
		/// </summary>
		/// <param name="stack">This stack.</param>
		public static void Add([DisallowNull] this IStack<Decimal> stack) {
