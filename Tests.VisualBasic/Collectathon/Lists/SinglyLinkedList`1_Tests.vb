...
Namespace Collectathon.Lists
	Public Class SinglyLinkedList_1_Tests
		<Theory>
		<InlineData(New Int32() {1, 2, 3, 4, 5})>
		Public Sub Clear(Array As Int32())
			Dim List = New SinglyLinkedList(Of Int32) From {Array}
		...
		Public Sub Queue(Array As Int32())
			Dim Queue = New SinglyLinkedList(Of Int32)
			Queue.Enqueue(Array)
		...
		Public Sub Remove_Delegate()
			Dim List = New SinglyLinkedList(Of Int32) From {1, 2, 3, 4, 5, 6, 7, 8, 9}
		...
		Public Sub Stack(Array As Int32())
			Dim Stack = New SinglyLinkedList(Of Int32)
			Stack.Push(Array)
		...
		<Fact>
		Public Sub Unique()
			Dim List = New SinglyLinkedList(Of Int32)(Filter.Unique)
			List.Add(1)
