...
namespace System {
	public static partial class TraitExtensions {
		...
		/// </remarks>
		[return: MaybeNull]
		public static TElement Fold<TElement>([DisallowNull] this Collections.Generic.IEnumerable<TElement> collection, [DisallowNull] Func<TElement, TElement, TElement> func, [AllowNull] TElement identity) {
