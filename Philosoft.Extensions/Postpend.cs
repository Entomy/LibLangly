...
namespace System {
	public static partial class TraitExtensions {
		...
		/// <param name="collection">This collection.</param>
		/// <param name="elements">The elements to postpend.</param>
		public static void Postpend<TElement, TEnumerator>([DisallowNull] this IPostpend<TElement> collection, [AllowNull] IGetEnumerator<TElement, TEnumerator> elements) where TEnumerator : notnull, ICurrent<TElement>, IMoveNext {
			if (elements is not null) {
				foreach (TElement element in elements) {
					collection.Postpend(element);
				}
