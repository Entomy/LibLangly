...
namespace System {
	public static partial class TraitExtensions {
		...
		/// <exception cref="ArgumentException">The destination is shorter than this sequence.</exception>
		/// <exception cref="ArgumentNullException">The destination is <see langword="null"/>.</exception>
		public static void CopyTo<TElement, TEnumerator>([DisallowNull] this ISequence<TElement, TEnumerator> collection, ArraySegment<TElement?> array) where TEnumerator : IEnumerator<TElement> => CopyTo(collection, array.AsSpan());
