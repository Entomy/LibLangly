...
[assembly: SuppressMessage("Maintainability", "AV1564:Parameter in public or internal member is of type bool or bool?", Justification = "This is fine at times. Enums are preferrable, but not always necessary.")]
...
[assembly: SuppressMessage("Style", "IDE0011:Add braces", Justification = "This isn't necessary in simple cases. I'm leaving this up to human review.")]
...
[assembly: UnconditionalSuppressMessage("SDK", "NETSDK1138", Justification = "These are libraries, so we're supporting the oldest possible. Applications are responsible for using supported runtime targets.")]
