...
namespace Numbersome {
	public static partial class TrigonometryExtensions {
		...
		public static T Cvs<T>(this T value) where T : IFloatingPoint<T> => T.One - T.Sin(value);
		...
		public static void Cvs<T>(this IStack<T> stack) where T : IFloatingPoint<T> => stack.Push(stack.Pop().Cvs());
	}
}
