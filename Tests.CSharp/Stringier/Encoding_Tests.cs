...
namespace Stringier {
	...
	public class Encoding_Tests {
		...
		[Fact]
		public void UTF8_Decode_Gibberish() => UTF8.Decode(Random.NextBytes(5_000).ToArray());
		...
		[Fact]
		public void UTF8_Encode_Gibberish() => UTF8.Encode(Random.NextRunes(5_000).ToArray());
		...
		[Fact]
		public void UTF16_Decode_Gibberish() => UTF16.Decode(Random.NextChars(5_000).ToArray());
		...
		[Fact]
		public void UTF16_Encode_Gibberish() => UTF16.Encode(Random.NextRunes(5_000).ToArray());
