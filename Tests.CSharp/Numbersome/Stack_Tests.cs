...
namespace Numbersome {
	public class Stack_Tests : Tests {
		...
		public void BitDecrement_Double() {
			...
			stack.BitDecrement();
			Assert(stack.Pop()).Equals(Math.BitDecrement(1.0));
		}
		...
		public void BitIncrement_Double() {
			IStack<Double> stack = new BoundedArray<Double>(1.0);
			stack.BitIncrement();
			Assert(stack.Pop()).Equals(Math.BitIncrement(1.0));
		}
		...
		public void Cbrt_Double() {
			IStack<Double> stack = new BoundedArray<Double>(1.0);
			stack.Cbrt();
			Assert(stack.Pop()).Equals(Math.Cbrt(1.0));
		}
		...
		public void Ceiling_Decimal() {
			...
			stack.Ceiling();
			Assert(stack.Pop()).Equals(Math.Ceiling(0.5m));
		}
		...
		public void Ceiling_Double() {
			...
			stack.Ceiling();
			Assert(stack.Pop()).Equals(Math.Ceiling(0.5));
		}
		...
		public void CopySign_Double() {
			IStack<Double> stack = new BoundedArray<Double>(1.0, -1.0);
			stack.CopySign();
			Assert(stack.Pop()).Equals(Math.CopySign(1.0, -1.0));
		}
		...
		public void Divide_Single() {
			...
			stack.Divide();
			Assert(stack.Pop()).Equals(4.0f / 2.0f);
		}
		...
		public void Divide_Double() {
			...
			stack.Divide();
			Assert(stack.Pop()).Equals(4.0 / 2.0);
		}
		...
		public void Divide_Decimal() {
			...
			stack.Divide();
			Assert(stack.Pop()).Equals(4.0m / 2.0m);
		}
		...
		public void Exp_Double() {
			...
			stack.Exp();
			Assert(stack.Pop()).Equals(Math.Exp(2.0));
		}
		...
		public void Floor_Decimal() {
			IStack<Decimal> stack = new BoundedArray<Decimal>(0.5m);
			stack.Floor();
			Assert(stack.Pop()).Equals(Math.Floor(0.5m));
		}
		...
		public void Floor_Double() {
			IStack<Double> stack = new BoundedArray<Double>(0.5);
			stack.Floor();
			Assert(stack.Pop()).Equals(Math.Floor(0.5));
		}
		...
		public void IEEERemainder_Double() {
			IStack<Double> stack = new BoundedArray<Double>(4.0, 2.0);
			stack.IEEERemainder();
			Assert(stack.Pop()).Equals(Math.IEEERemainder(4.0, 2.0));
		}
		...
		public void ILogB_Double() {
			IStack<Double> stack = new BoundedArray<Double>(2.0);
			stack.ILogB();
			Assert(stack.Pop()).Equals(Math.ILogB(2.0));
		}
		...
		public void Log_Double() {
			IStack<Double> stack = new BoundedArray<Double>(2.0);
			stack.Log();
			Assert(stack.Pop()).Equals(Math.Log(2.0));
		}
		...
		public void Log10_Double() {
			IStack<Double> stack = new BoundedArray<Double>(2.0);
			stack.Log10();
			Assert(stack.Pop()).Equals(Math.Log10(2.0));
		}
		...
		public void Log2_Double() {
			IStack<Double> stack = new BoundedArray<Double>(2.0);
			stack.Log2();
			Assert(stack.Pop()).Equals(Math.Log2(2.0));
		}
		...
		public void Pow_Double() {
			IStack<Double> stack = new BoundedArray<Double>(1.0, 2.0);
			stack.Pow();
			Assert(stack.Pop()).Equals(Math.Pow(1.0, 2.0));
		}
		...
		public void Sqrt_Double() {
			IStack<Double> stack = new BoundedArray<Double>(1.0);
			stack.Sqrt();
			Assert(stack.Pop()).Equals(Math.Sqrt(1.0));
		}
		...
		public void Truncate_Double() {
			IStack<Double> stack = new BoundedArray<Double>(0.5);
			stack.Truncate();
			Assert(stack.Pop()).Equals(Math.Truncate(0.5));
		}
		...
		public void Truncate_Decimal() {
			IStack<Decimal> stack = new BoundedArray<Decimal>(0.5m);
			stack.Truncate();
			Assert(stack.Pop()).Equals(Math.Truncate(0.5m));
		}
	}
}
