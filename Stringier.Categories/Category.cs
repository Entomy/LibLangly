...
namespace Stringier {
	...
	public class Category : Set<Rune>, IContains<Char> {
		#region Discrete
		/// <summary>
		/// A box-drawing character.
		/// </summary>
		[DisallowNull, NotNull]
		public static Category BoxDrawing { get; } = Range(new Rune('\u2500'), new Rune('\u257F'));
		...
		/// </summary>
		[DisallowNull, NotNull]
		public static Category Subscript { get; } = Range(new Rune('\u2080'), new Rune('\u209C'));
		...
		protected Category([DisallowNull] Predicate<Rune> predicate) : base(predicate) { }

		/// <summary>
		/// Initializes a new <see cref="Category"/>.
		/// </summary>
		/// <param name="elements">The elements of the set.</param>
		protected Category([DisallowNull] params Rune[] elements) : base(elements) { }
