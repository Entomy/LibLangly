...
namespace Langly {
	...
	public interface IRefIndexable<in TIndex, TElement> : IReadOnlyRefIndexable<TIndex, TElement> {
		/// <summary>
		/// Gets or sets the element at the specified index.
		/// </summary>
		/// <param name="index">The index of the element to get or set.</param>
		/// <returns>The element at the specified index.</returns>
		/// <exception cref="ArgumentOutOfRangeException"><paramref name="index"/> is not a valid index in the <see cref="IRefIndexable{TIndex, TElement}"/>.</exception>
		/// <exception cref="NotSupportedException">The property is set and the <see cref="IRefIndexable{TIndex, TElement}"/> is read-only.</exception>
