...
module RangerExtensions =
    type Binding =
        ...
        static member NRange(left:Pattern, right:String) = PatternBindings.NestedRanger(left, right)
        static member NRange(left:String, right:Pattern) = PatternBindings.NestedRanger(left, right)
        static member NRange(left:Pattern, right:Char) = PatternBindings.NestedRanger(left, right)
        static member NRange(left:Char, right:Pattern) = PatternBindings.NestedRanger(left, right)
        static member NRange(left:String, right:String) = PatternBindings.NestedRanger(left, right)
        static member NRange(left:String, right:Char) = PatternBindings.NestedRanger(left, right)
        static member NRange(left:Char, right:String) = PatternBindings.NestedRanger(left, right)
        static member NRange(left:Char, right:Char) = PatternBindings.NestedRanger(left, right)
