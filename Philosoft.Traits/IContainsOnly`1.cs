...
namespace System.Traits {
	...
	public interface IContainsOnly<TElement> : IContains<TElement> {
		...
		Boolean ContainsOnly([AllowNull] TElement element);
		...
		Boolean ContainsOnly([AllowNull] params TElement?[] elements);
		...
		/// <param name="elements">The elements to attempt to find.</param>
		/// <returns><see langword="true"/> if the <paramref name="elements"/> are the only things contained in this collection; otherwise <see langword="false"/>.</returns>
		Boolean ContainsOnly(ArraySegment<TElement?> elements);
		...
		/// <param name="elements">The elements to attempt to find.</param>
		/// <returns><see langword="true"/> if the <paramref name="elements"/> are the only things contained in this collection; otherwise <see langword="false"/>.</returns>
		Boolean ContainsOnly(Memory<TElement?> elements);
		...
		/// <param name="elements">The elements to attempt to find.</param>
		/// <returns><see langword="true"/> if the <paramref name="elements"/> are the only things contained in this collection; otherwise <see langword="false"/>.</returns>
		Boolean ContainsOnly(ReadOnlyMemory<TElement?> elements);
		...
		/// <param name="elements">The elements to attempt to find.</param>
		/// <returns><see langword="true"/> if the <paramref name="elements"/> are the only things contained in this collection; otherwise <see langword="false"/>.</returns>
		Boolean ContainsOnly(Span<TElement?> elements);
		...
		/// <param name="elements">The elements to attempt to find.</param>
		/// <returns><see langword="true"/> if the <paramref name="elements"/> are the only things contained in this collection; otherwise <see langword="false"/>.</returns>
		Boolean ContainsOnly(ReadOnlySpan<TElement?> elements);
		...
		Boolean ContainsOnly([AllowNull] Predicate<TElement?> predicate);
	}
}
