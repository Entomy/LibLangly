...
namespace Langly.Exceptions {
	...
	public class ArgumentNotTypeException : ArgumentException {
		...
		protected ArgumentNotTypeException(System.Object value, String name, String message) : base(value, name, message) { }
		...
		public static ArgumentNotTypeException With<TType>(System.Object value, String name) => new ArgumentNotTypeException(value?.GetType().Name, name, $"Argument not of type '{typeof(TType).Name}'.");
	}
}
