...
namespace Langly.Exceptions {
	...
	/// </summary>
	[Serializable]
	public class ArgumentEqualException : ArgumentValueException {
		/// <summary>
		...
		protected ArgumentEqualException(System.Object value, String name, String message) : base(value, name, message) { }
