...
namespace Langly.Exceptions {
	...
	/// </summary>
	[Serializable]
	public class ArgumentNullException : ArgumentValueException {
		/// <summary>
		...
		protected ArgumentNullException(System.Object value, String name, String message) : base(value, name, message) { }
