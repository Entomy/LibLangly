...
namespace Langly {
	public static partial class Guard {
		...
		/// <param name="collection">The collection being indexed.</param>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static void Index<T>(nint value, String name, IIndexReadOnly<T> collection) {
		...
		/// <param name="collection">The collection being indexed.</param>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static void Index<T>(nint value, String name, IIndexRefReadOnly<T> collection) {
			if ((nuint)value >= (nuint)collection.Count) {
				throw ArgumentIndexNotValidException.With(value, name, collection);
			}
		}
