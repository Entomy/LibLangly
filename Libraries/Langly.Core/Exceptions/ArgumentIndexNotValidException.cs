...
namespace Langly.Exceptions {
	...
	public class ArgumentIndexNotValidException : ArgumentNotValidException {
		...
		protected ArgumentIndexNotValidException(System.Object value, String name, String message) : base(value, name, message) { }
		...
		/// <param name="collection">The collection being indexed.</param>
		/// <returns>An <see cref="ArgumentIndexNotValidException"/> instance.</returns>
		public static ArgumentIndexNotValidException With<TIndex, TElement>(TIndex value, String name, IIndexReadOnly<TIndex, TElement> collection) => new ArgumentIndexNotValidException(value, name, $"Index must be one of the indicies present in the collection.");
		...
		/// <param name="collection">The collection being indexed.</param>
		/// <returns>An <see cref="ArgumentIndexNotValidException"/> instance.</returns>
		public static ArgumentIndexNotValidException With<TIndex, TElement>(TIndex value, String name, IIndexRefReadOnly<TIndex, TElement> collection) => new ArgumentIndexNotValidException(value, name, $"Index must be one of the indicies present in the collection.");
