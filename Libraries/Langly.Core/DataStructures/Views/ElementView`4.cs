...
namespace Langly.DataStructures.Views {
	/// <summary>
	/// Provides a limited view of the elements of a collection.
	/// </summary>
	...
	public readonly partial struct ElementView<TIndex, TElement, TCollection, TEnumerator>
		...
		public ElementView([DisallowNull] TCollection collection) => Collection = collection;
