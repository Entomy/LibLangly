...
namespace Langly.DataStructures {
	...
	internal sealed class Difference<TElement, TFirst, TSecond> : Combinator<TElement, TFirst, TSecond>
		where TFirst : Set<TElement>
		where TSecond : Set<TElement>{
		/// <summary>
		/// Initializes a new <see cref="Difference{TElement, TFirst, TSecond}"/>.
		/// </summary>
		/// <param name="first">The first set.</param>
		/// <param name="second">The second set.</param>
		internal Difference([DisallowNull] TFirst first, [DisallowNull] TSecond second) : base(first, second) { }
