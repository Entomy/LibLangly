...
namespace Stringier {
	public static partial class StringierExtensions {
		/// <summary>
		/// Indicates whether this <see cref="Char"/> is categorized as a letter or a decimal digit.
		/// </summary>
		...
		/// <summary>
		/// Indicates whether this <see cref="Rune"/> is categorized as a letter or a decimal digit.
		/// </summary>
