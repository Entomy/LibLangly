...
namespace Stringier {
	public static partial class StringierExtensions {
		...
		public static Boolean Contains([ValidatedNotNull] this String @string, Char value) {
		...
		/// <returns><see langword="true"/> if the value parameter occurs within this string; otherwise, <see langword="false"/>.</returns>
		public static Boolean Contains([ValidatedNotNull] this String @string, Rune value) {
			Guard.NotNull(@string, nameof(@string));
		...
		public static Boolean Contains([ValidatedNotNull] this IEnumerable<String> strings, Char value) {
		...
		/// <param name="value">The rune to seek.</param>
		/// <returns><see langword="true"/> if the value parameter occurs within any of the strings; otherwise, <see langword="false"/>.</returns>
		public static Boolean Contains([ValidatedNotNull] this IEnumerable<String> strings, Rune value) {
			Guard.NotNull(strings, nameof(strings));
			foreach (String @string in strings) {
				if (@string.Contains(value)) {
					return true;
		...
		/// <returns><see langword="true"/> if the value parameter occurs within any of the strings; otherwise, <see langword="false"/>.</returns>
		public static Boolean Contains([ValidatedNotNull] this IEnumerable<String> strings, String value) {
			Guard.NotNull(strings, nameof(strings));
